					...
					<Tooltip>
						<TooltipTrigger class="w-[160px]">
							<Select v-model:model-value="node.attrs.language">
								<SelectTrigger
									class="h-7 w-[160px] border-none text-sm outline-none hover:bg-[#5a5d5e4f]"
								>
									<SelectValue placeholder="Select language" />
								</SelectTrigger>
								<SelectContent
									class="border-[#3a3f4b] bg-[#21252b] text-[#ccc]"
				...
				<TooltipProvider :delay-duration="0">
					<Tooltip>
						<TooltipTrigger>
							<div
								@click="copyCode"
								class="flex h-7 w-7 cursor-pointer items-center justify-center rounded-sm hover:bg-[#5a5d5e4f]"
							>
								<Icon name="Copy" class="h-4 w-4"></Icon>
							</div>
						</TooltipTrigger>
						<TooltipContent :side-offset="5">
				...
				<TooltipProvider :delay-duration="0">
					<Tooltip>
						<TooltipTrigger>
							...
							>
								<Icon name="List" class="h-4 w-4"></Icon>
							</div>
						</TooltipTrigger>
						<TooltipContent :side-offset="5">
				...
				<TooltipProvider :delay-duration="0">
					<Tooltip>
						<TooltipTrigger>
							...
							>
								<Icon name="WrapText" class="h-4 w-4"></Icon>
							</div>
						</TooltipTrigger>
						<TooltipContent :side-offset="5">
							{{ $t('editor.codeblock.wordWrap') }}
						</TooltipContent>
					</Tooltip>
				</TooltipProvider>
					...
					<Tooltip>
						<TooltipTrigger>
							<Select v-model:model-value="node.attrs.tabSize">
								<SelectTrigger
									class="h-7 w-[60px] border-none text-sm outline-none hover:bg-[#5a5d5e4f]"
								>
									<Icon name="IndentIncrease" class="h-4 w-4" />
								</SelectTrigger>
								<SelectContent
									class="border-[#3a3f4b] bg-[#21252b] text-[#ccc]"
									@close-auto-focus="(e) => e.preventDefault()"
...
const onUpdatePrismCode = (value: string) => {
...
onMounted(() => {
	...
	codeEditor.value = createEditor(containerRef.value, {
		...
		// 		// props.updateAttributes({ code: value })
		// 		// console.log('[PROPS]', props.updateAttributes)
		// 	}
		// },
		onUpdate: onUpdatePrismCode
	})
